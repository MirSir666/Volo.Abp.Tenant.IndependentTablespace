...
public class SamplesDbContext :
    AbpDbContext<SamplesDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SamplesConsts.DbTablePrefix + "Books", SamplesConsts.DbSchema);
        ...
        {
            b.ToTable(SamplesConsts.DbTablePrefix + "Authors",
                SamplesConsts.DbSchema);
        ...
        //{
        //    b.ToTable(SamplesConsts.DbTablePrefix + "YourEntities", SamplesConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
