...
namespace IndependentTablespace.Samples.Migrations
{
    ...
    [Migration("20250209101014_2025init")]
    partial class _2025init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndependentTablespace.Samples.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("IndependentTablespace.Samples.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IndependentTablespace.Samples.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IndependentTablespace.Samples.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IndependentTablespace.Samples.Books.Book", b =>
                {
                    b.HasOne("IndependentTablespace.Samples.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IndependentTablespace.Samples.Customers.Customer", b =>
                {
                    b.HasOne("IndependentTablespace.Samples.Departments.Department", "Department")
                        .WithMany()
