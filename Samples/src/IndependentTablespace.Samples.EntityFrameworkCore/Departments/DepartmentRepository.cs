...
{
    public class DepartmentRepository : EfCoreRepository<SamplesDbContext, Department, Guid>,
        IDepartmentRepository
    {
        private readonly IDbContextProvider<SamplesDbContext> dbContextProvider;

        public DepartmentRepository(
        IDbContextProvider<SamplesDbContext> dbContextProvider)
        : base(dbContextProvider)
        {
            this.dbContextProvider = dbContextProvider;
        }

        private static readonly Func<SamplesDbContext, Guid, Task<Department>> GetByIdQuery =
            EF.CompileAsyncQuery((SamplesDbContext db, Guid id) =>
